...
class _OrderMethodState extends State<OrderMethod> {
  ...
  child: Container(
    ...
    height: 290,
    width: 360,
    padding: EdgeInsets.only(left: 10), // Điều chỉnh khoảng lề ngang ở đây
    child: Column(
      children: [
        SizedBox(height: 20),
        Row(
  mainAxisAlignment: MainAxisAlignment.center, // Đặt hàng giữa giữa
  crossAxisAlignment: CrossAxisAlignment.start, // Đặt nút bấm theo cạnh trên
  children: [
    Text(
      "Nguyễn Quốc Khánh",
      style: TextStyle(
    ...
    ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        padding: EdgeInsets.symmetric(
         vertical: 5,// Điều chỉnh khoảng cách dọc ở đây
          horizontal: 5, // Điều chỉnh khoảng lề ngang ở đây
        ),
          shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.only(
        bottomLeft: Radius.circular(20),  // Đặt bán kính góc ở phía dưới bên trái
        bottomRight: Radius.circular(20), // Đặt bán kính góc ở phía dưới bên phải
      ),
    ),
      ),
      child: Text(
        "Nội dung nút của bạn",
        style: TextStyle(
          fontSize: 8, // Điều chỉnh kích thước văn bản
        ),
      ),
    ),
  ],
